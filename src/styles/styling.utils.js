...
const defaultValues = {
  ...
  background: themeType.colors.primary,
...
export const margin = ({ theme }) =>
  theme.margin ? theme.margin : defaultValues.margin;
...
export const flexJustifyContent = ({ theme }) =>
  theme.justifyContent
    ? theme.justifyContent
    : defaultValues.flex.justifyContent;
...
export const color = ({ theme }) =>
  theme.color ? theme.color : defaultValues.color;
